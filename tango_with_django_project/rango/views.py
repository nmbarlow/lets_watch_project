...
def user_signup (request):
	...
	return render(request,'rango/signup.html',{'user_form':user_form,'profile_form':profile_form,'registered':registered})
...
def show_user(request):
	...
	return render(request,'rango/userprofile.html',{'profile_form':profile_form})
...
def user_signin(request):
	if request.method=='POST':
		...
		return render(request,'rango/signin.html',{})
