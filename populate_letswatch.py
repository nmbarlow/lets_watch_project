...
def populate():
    ...
    western_movies =[
        ...
        {"title" : "The Magnificent Seven (2016)",
         ...
         "year" : "2016",
         "thumb" : "movies/the_magnificent_seven_(2016).png",
        ...
        {"title" : "The Magnificent Seven (1960)",
         ...
         "year" : "1960",
         "thumb" : "movies/the_magnificent_seven_(1960).png",
         "description" : ""}
    ...
    scifi_movies =[
        ...
        {"title" : "Star Wars: The Force Awakens",
         ...
         "year" : "2015",
         "thumb" : "movies/star_wars_the_force_awakens.png",
    ...
    animation_movies =[
        ...
        {"title" : "Incredibles 2",
         ...
         "year" : "2018",
         "thumb" : "movies/incredibles_2.png",
    ...
    for gen, gen_data in gens.items():
        ...
        for m in gen_data["movies"]:
            add_movie(g, m["title"], m["url"], m["year"], m["thumb"], m["description"])

    for g in Genre.objects.all():
        for m in Movie.objects.filter(genre=g):
            print( "- {0} - {1}". format(str(g), str(m)))

def add_movie(genre, title, url, year, thumb, description):
